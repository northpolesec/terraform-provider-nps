...
require (
	buf.build/gen/go/northpolesec/workshop-api/grpc/go v1.6.2-20260612152406-a61a3350660f.1
	buf.build/gen/go/northpolesec/workshop-api/protocolbuffers/go v1.36.11-20260615234553-e2fefd244c23.1
