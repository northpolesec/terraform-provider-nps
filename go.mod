...
require (
	buf.build/gen/go/northpolesec/workshop-api/grpc/go v1.6.2-20260527220725-f73a5fe821d2.1
	buf.build/gen/go/northpolesec/workshop-api/protocolbuffers/go v1.36.11-20260527220725-f73a5fe821d2.1
